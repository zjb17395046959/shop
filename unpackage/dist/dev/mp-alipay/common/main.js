...
"use strict";
/* WEBPACK VAR INJECTION */(function(uni, uniCloud, createApp) {__webpack_require__(/*! uni-pages */ 4);var _vue = _interopRequireDefault(__webpack_require__(/*! vue */ 2));
var _App = _interopRequireDefault(__webpack_require__(/*! ./App */ 5));
__webpack_require__(/*! ./static/css/iconfont.css */ 11);


var _model = __webpack_require__(/*! ./static/js/model.js */ 12);



var _lib = _interopRequireDefault(__webpack_require__(/*! ./common/lib.js */ 14));

var _config = _interopRequireDefault(__webpack_require__(/*! ./common/config.js */ 15));



var _format = _interopRequireDefault(__webpack_require__(/*! ./common/format.js */ 16));
...
var _main = _interopRequireDefault(__webpack_require__(/*! ./static/js/main.js */ 181));
...
_vue.default.prototype.PinYinMatch = _main.default; //封装全局的请求云函数的方法
_vue.default.prototype.$http = function (name) {var data = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : '';uni.showLoading({ title: '加载中' });
...
_vue.default.filter('format_ipone', function (val) {
  if (val) {
    var reg = /^(\d{3})\d{4}(\d{4})$/;
...
createApp(app).$mount();
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! ./node_modules/@dcloudio/uni-mp-alipay/dist/index.js */ 1)["default"], __webpack_require__(/*! ./node_modules/@dcloudio/vue-cli-plugin-uni/packages/uni-cloud/dist/index.js */ 194)["default"], __webpack_require__(/*! ./node_modules/@dcloudio/uni-mp-alipay/dist/index.js */ 1)["createApp"]))
